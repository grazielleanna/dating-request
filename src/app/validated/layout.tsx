            ...
            <body className={poppins.className}>
                ...
                <main className="flex min-h-screen flex-col items-center justify-between p-8 lg:p-24 bg-blue">
                    ...
                    <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
                        <p className="fixed left-0 top-0 text-white flex w-full justify-center border-b border-gray-300 from-zinc-200 py-4 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:text-black lg:p-4 lg:dark:bg-zinc-800/30">
                            Dating request ❤️
                        </p>
